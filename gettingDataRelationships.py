...
#constants
csv_file_name = "bills_data_new_format.csv"
STATE = "WI"

def directory_exists():
    os.makedirs('BillTextRelationships', exist_ok=True)
...
def get_master_list():
    ...
    for key, bill in data["masterlist"].items():
        ...
        new_bill_data = {
            ...
            "links": {
                "pdf": f"BillTextRelationships/bill_{doc_id}.pdf" if doc_id else None,
                "txt": f"BillTextRelationships/bill_{doc_id}.txt" if doc_id else None
            },
    ...
    output_file = "newFormatData.json"
    ...
    if response.status_code == 200:
        ...
        if text_data and 'doc' in text_data:
            ...
            try:
                ...
                #save pdf
                pdf_file = f"BillTextRelationships/bill_{doc_id}.pdf"
                ...
                #save extracted text
                txt_file = f"BillTextRelationships/bill_{doc_id}.txt"
...
def save_to_csv(bills):
    output_file = "bills_data_new_format.csv"
...
if __name__ == "__main__":
    ...
    output_json = "newFormatData.json"
